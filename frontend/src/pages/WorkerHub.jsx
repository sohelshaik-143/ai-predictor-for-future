    ...
    <div style={bg}>
      ...
      <div style={{ position: "relative", zIndex: 1, padding: "1.5rem", maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "2rem", flexWrap: "wrap" }}>
          <button onClick={() => navigate("/my-dashboard")} style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "0.75rem", padding: "0.5rem 1rem", color: "rgba(255,255,255,0.6)", cursor: "pointer", fontWeight: 600 }}>← My Dashboard</button>
          <div>
